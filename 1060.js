...
for (let numeroPossibilidades = 0; numeroPossibilidades < 6; numeroPossibilidades += 6) {
    if (valor1 > 0) qtdePositivos += 1;
    if (valor2 > 0) qtdePositivos += 1;
    if (valor3 > 0) qtdePositivos += 1;
    if (valor4 > 0) qtdePositivos += 1;
    if (valor5 > 0) qtdePositivos += 1;
    if (valor6 > 0) qtdePositivos += 1;
